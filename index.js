...
console.log("emails:", email.mailboxes);
console.log("2nd email body:", email.mailboxes.starred[1].body);
email.mailboxes.drafts[2].sent = true;
console.log("marked as sent", email.mailboxes.drafts[2]);
email.mailboxes.drafts.push({to: "person6", subject: "its dat boi", body: "oh shiiiiit waddup" , sent: false})
console.log(email.mailboxes.drafts[3]);